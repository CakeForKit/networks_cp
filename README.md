...
Вопрос: Какую операционную систему использовать? Linux
...
Вопрос: На каком языке программирования писать? - С
...
Вопрос: Какие библиотеки можно использовать? стандартные
